...
namespace WEB2.Areas.Admin.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,ProductId,Quantity,Status,Price,IDSKU,Discount,Total,Color,version,Fulfilled")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,ProductId,Quantity,Status,Price,IDSKU,Discount,Total,Color,version,Fulfilled")] OrderDetail orderDetail)
        {
